...
<?php
	...
	if($frisian=="true"){
		$message = "User ".$name.", ID ".$id.", has indicated he/she speaks Frisian. The user's email adress is: ".$email."\n\n  Regards, The System";
		mail("bachelorproject@korpel.net","Frisian speaker participated",$message,"");
	}
?>
<html>
	<head>
	...
	<body bgcolor=#ddd>
		...
		<section class="subject">
			<center>
				...
				<p align="left">
					Ik stem toe om mee te doen aan een onderzoek dat wordt uitgevoerd door <a href="mailto:bachelorproject@korpel.net">Michiel Korpel</a> &amp; <a href="mailto:j.k.spenader@rug.nl">Jennifer Spenader</a>.<br><br>
				...
				<form name="info" method="post" action="<?php
					echo 'http://bachelorproject.korpel.net/bp/instruct.php'; ?>" onsubmit="return checked(this)">
